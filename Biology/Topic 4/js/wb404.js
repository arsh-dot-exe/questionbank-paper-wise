(function() {
    ...
    if (page_url == 'https://archive.org/about/404.html')
        return; // dont check for our own 404 page
    var wb404_url = 'https://archive.org/wayback/available?callback=wb404_callback&url=' + encodeURIComponent(page_url);
    s.src = wb404_url;
